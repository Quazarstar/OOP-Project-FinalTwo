 ...
 * @author john
 */
public class SafetyFrame extends javax.swing.JFrame {

    /**
     * Creates new form SafetyFrame
     */
    public SafetyFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Return to subjects");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SafetyFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SafetyFrame().setVisible(true);
            }
        });
    }
